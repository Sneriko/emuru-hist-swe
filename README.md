...
> This working copy includes a Riksarkivet extension for historical Swedish
> PAGE-XML data. See [HISTORICAL_SWEDISH.md](HISTORICAL_SWEDISH.md) for complete
> data-preparation and fine-tuning instructions. Upstream files remain intact;
> the extension lives in `historical_swedish/`, `scripts/`, and
> `configs/historical_swedish/`.
